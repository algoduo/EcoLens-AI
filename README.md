...
## 🚀 Key Features
- **AI-Powered Identification:** Uses Google Gemini 1.5 Flash to identify waste materials from text or image descriptions.
...
| **AI Brain** | Google Gemini 1.5 Flash (Multimodal LLM) |
